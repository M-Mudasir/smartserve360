...
export default function Vendor() {
    ...
    const columns = [
        ...
        { id: "quantityRequested", label: "Quantity Requested", minWidth: 45 },
        { id: "quantityAllocated", label: "Quantity Allocated", minWidth: 45 },
    ...
    return (
        <div className={styles.inventory} >
            <div className="head d-flex justify-content-between">
                <div>
                    <div className="pageHead">Vendor Portal </div>
                    <div className="PrevPath d-flex mt-1">Vendor Portal / <div className="currentPath"> &nbsp; Procurement Orders</div></div>
                </div>
          ...
          <div className="d-flex align-items-center">
            ...
            >
              ...
              <MenuList sx={{ py: 2, textAlign: "start", width: "12rem" }}>
                ...
                <DeatailsTable dummyData={filteredItems} columns={columns} title='Vendor Portal'></DeatailsTable>
            </div>
        </div>
    );
}